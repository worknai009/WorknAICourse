                    ...
                    <AnimatePresence>
                      {isDropdownOpen && (
                        <motion.div
                          ...
                          className={`absolute left-0 right-0 mt-2 p-2 rounded-2xl border shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-3xl overflow-hidden max-h-[220px] overflow-y-auto ${
                            isDarkMode
